...
function LandingPage() {
  const testimonials = [
    {
      ...
      image:
        "https://i.pinimg.com/736x/3a/b1/ce/3ab1ce88c1d2bae5758ce1924c01cb20.jpg",
    },
    {
      quote:
    ...
    },
    {
      ...
      position: "Manager, Together Holdings",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0_qo5E8LYiICADhdFu6-BWsvwnE-b0CmJhA&s",
    },
  ];
  ...
  return (
    <div>
      ...
      <div
        id="home"
        className="py-20 px-6 sm:px-20 max-w-[90%] mx-auto mt-12 rounded-lg min-h-[calc(100vh-150px)] flex items-center justify-center"
      >
        <div className="flex flex-col lg:flex-row justify-between items-center w-full flex-wrap">
          <div className="flex flex-col items-start space-y-10 max-w-full lg:max-w-[50%]">
            <h1 className="text-4xl sm:text-6xl font-bold leading-tight text-center lg:text-left">
              Welcome to <br /> PRIME BANK – Where Your Financial Aspirations
              Come to Life!
            </h1>
            <p className="text-lg sm:text-2xl leading-relaxed text-center lg:text-left">
              At Prime Bank, we strive to offer a full range of banking
              solutions designed to empower both individuals and businesses in
              reaching their financial aspirations. Our commitment lies in
              delivering tailored and innovative services that put our
          ...
          <img
            src="https://i.pinimg.com/564x/f9/7d/6f/f97d6faa8e85209f82041e1f1b32628d.jpg"
      ...
      <div
        id="accounts"
        className="py-20 px-6 sm:px-20 max-w-[90%] mx-auto mt-12"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="bg-gray-100 p-12 rounded-lg shadow-md flex flex-col items-center h-80 transition-transform transform hover:scale-105 hover:bg-teal-50">
            ...
            <p className="text-lg text-gray-700 mt-4 text-center">
              Elevate your business management with our trusted business
              account.
            </p>
          </div>
          <div className="bg-gray-100 p-12 rounded-lg shadow-md flex flex-col items-center h-80 transition-transform transform hover:scale-105 hover:bg-teal-50">
      ...
      >
        <div className="max-w-[90%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-2xl font-semibold mb-4">Finance Services</h4>
            <ul>
              <li>
                <a href="#credit" className="text-lg hover:text-teal-500">
                  Credit
                </a>
              </li>
              <li>
                <a href="#loans" className="text-lg hover:text-teal-500">
                  Loans
                </a>
              </li>
              <li>
                <a href="#investment" className="text-lg hover:text-teal-500">
                  Investment
                </a>
              </li>
              <li>
                <a href="#savings" className="text-lg hover:text-teal-500">
                  Savings
                </a>
              </li>
            </ul>
        ...
        {/* Footer Bottom - Brand and Copyright */}
        <div className="mt-12 text-center">
          <p className="text-lg font-bold">PRIME Bank</p>
          <p className="text-sm mt-2">© 2023 PRIME Bank. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
