...
import { idlFactory } from './prime-bank-ai-backend.did.js';
export { idlFactory } from './prime-bank-ai-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRIME_BANK_AI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./prime-bank-ai-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the prime-bank-ai-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./prime-bank-ai-backend.did.js")._SERVICE>}
 */
export const prime_bank_ai_backend = createActor(canisterId);
